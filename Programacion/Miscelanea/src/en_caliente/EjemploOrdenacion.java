...
public class EjemploOrdenacion {
    ...
    public static void main(String[] args) {
        ...
        Comparator cmpFechaNacimiento = new Comparator() {
            @Override
            public int compare(Object cli1, Object cli2) {
                if (cli1 instanceof Cliente && cli2 instanceof Cliente) {
                    Cliente cliente1 = (Cliente) cli1;
        ...
        Arrays.sort(clientesOrdenadosPorNombre, cmpFechaNacimiento);
        System.out.println("Los clientes ordenados por fecha de nacimiento son: " + Arrays.toString(clientesOrdenadosPorNombre));
