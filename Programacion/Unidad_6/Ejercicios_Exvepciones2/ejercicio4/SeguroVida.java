...
/**
 * La prima de un seguro de vida se calcula como un factor multiplicado por la
 * edad del asegurado.
 * <p>
 * La correlación del factor, a su vez, se calcula en base a la siguiente
 * relación:
 * 
 * @author jsanm
 */
public class SeguroVida extends Seguro {
    ...
    /**
     * Crea un seguro de decesos informando el asegurado. Delega en el constructor
     * heredado ya que
    ...
    /**
     * Calcula la prima anual en base a la edad del asegurado y un factor de
     * correlación para multiplicarlos
     * 
    ...
    /**
     * Calcula un factor de correlación multiplicativo de la edad en base a un
     * algoritmo
     * definido por el usuario.
     * 
     * @param edad edad cuyo factor se desea calcular. Máximo de 64 años, en caso
