...
/**
 * Escribe un programa que solicite los datos del asegurado (nombre, apellidos y
 * año de nacimiento)
 * y le pregunte si desea contratar un seguro de decesos o de vida y muestre el
 * importe de la prima anual correspondiente.
 * 
 * @author jsanm
 */
public class TestApp {
    ...
    public static void main(String[] args) {
        ...
        // 1º - Solicitamos los datos de entrada del asegurado. Nótse que permitimos no
        // introducir algún dato al usuario
        System.out.println("*** INFORMACIÓN DE ENTRADA DEL ASEGURADO ***");
        System.out.println(
                "Indique, por orden, el nombre, primer apellido, segundo apellido y año de nacimiento del asegurado.");
        ...
        // 2º - Creamos el asegurado en base al contenido introducido. Aquí internamente
        // se valida si algún dato
        ...
        // 4º - Creamos el objeto polimórfico dinámicamente en base a la decisión del
        // usuario
        ...
        // 5º - Calculamos con el método abstracto el importe de prima. En tiempo de
        // ejecución
