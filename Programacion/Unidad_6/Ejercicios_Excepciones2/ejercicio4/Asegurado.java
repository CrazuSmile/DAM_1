...
/**
 * Crea una clase Asegurado para poder almacenar la información de cualquier
 * asegurado en un sistema de gestión de seguros.
 * 
 * Todo asegurado consta de un año de nacimiento, nombre, primer apellido y
 * segundo apellido
 * (este último puede no estar informado, los demás son obligatorios).
 * 
 * Añade constructor y métodos getters y setters. Además, incluye una función
 * para calcular la edad del asegurado en función de la fecha actual (apoyarse
 * en la clase java.util.Calendar para conocer el momento actual).
 */
public class Asegurado {

    /**
     * Año de nacimiento del asegurado. Útil para hacer cálculos actuariales
     * indexados por edad.
     */
    ...
    /**
     * Crea un asegurado sin segundo apellido en base a la definición de
     * {@link #Asegurado(int, java.lang.String, java.lang.String, java.lang.String)
     * 
    ...
    /**
     * Establece el primer apellido del asegurado. No puede ser nulo ni cadena
     * vacía.
     * 
     * @param apellido1 Nuevo primer apellido del asegurado. No puede ser nulo ni
     *                  cadena vacía.
     */
    ...
    /**
     * Establece el segundo apellido del asegurado. Admite cualquier valor, incluso
     * cadena vacía y nulo.
     * 
     * @param apellido2
     */
    ...
    /**
     * Calcula la edad en base a la propiedad {@link #anyoNacimiento} y el año
     * actual.
     * <p>
     * Nótese que el valor calculado no se almacena en ninguna propiedad existente,
     * es un cálculo en caliente
     * que el método invocante deberá manejar como resultado de salida de esta
     * función.
     * 
