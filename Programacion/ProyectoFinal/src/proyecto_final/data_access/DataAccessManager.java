...
public class DataAccessManager implements AutoCloseable {
    ...
    /**
     * Crea una conexión a base de datos de MySQL según la configuración cargada
     * en {@link #dataBaseURL},
     * {@link #dataBaseUser} y {@link #dataBasePwd} (Dicha información se carga
     * al iniciarse el programa en {@link #loadDataBaseParams()})
     * <p>
     * Es un método privado para que la conexión a bbdd la maneje internamente
     * el objeto {@link #singleton}
     *
     * @return La conexión, si se puede establecer. Nulo en caso contrario (ej:
     * alguna excepción).
     */
    ...
    public void updatePokemonName(String oldName, String newName) throws SQLException {
        PokemonDAO pokemonDAO = new PokemonDAO(cnx);
        pokemonDAO.updatePokemonName(oldName, newName);
    }
